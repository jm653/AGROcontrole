...
urlpatterns = [
    ...
    path('excluir-propriedade/<int:id>/',     views.excluir_propriedade,    name='excluir_propriedade'),
    path('visualizar-propriedade/<int:id>/',  views.visualizar_propriedade, name='visualizar_propriedade'),

    path('lavouras/',                         views.lavouras_view,          name='lavouras'),
    path('cadastrar-lavoura/',                views.cadastrar_lavoura,      name='cadastrar_lavoura'),
    path('editar-lavoura/<int:id>/',          views.editar_lavoura,         name='editar_lavoura'),
    path('excluir-lavoura/<int:id>/',         views.excluir_lavoura,        name='excluir_lavoura'),
    path('visualizar-lavoura/<int:id>/',      views.visualizar_lavoura,     name='visualizar_lavoura'),

    path('lotes/',                            views.lotes_view,             name='lotes'),
    path('editar-lote/<int:id>/',             views.editar_lote,            name='editar_lote'),
    ...
    path('excluir-movimentacao/<int:id>/',    views.excluir_movimentacao,   name='excluir_movimentacao'),
